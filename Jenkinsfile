pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/Farha-Shwana/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('shwanaf-225-sp26')   // <---- Change this to match your kubernetes cluster credentials
    }
